...
def main_page():
    ...
    pd.read_csv('https://raw.githubusercontent.com/huhshin/streamlit/master/data_iris.csv')
...
# 파일실행: File > New > Terminal(anaconda prompt) - streamlit run streamlit0\5-3.layouts.py